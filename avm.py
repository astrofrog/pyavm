# avm - a python module to read AVM metadata
# Copyright (C) 2010 Thomas P. Robitaille

# Note - this should 'do the job' but could probably be written in a much more
# efficient way - suggestions are welcome! The ideas was to avoid any
# dependencies.
